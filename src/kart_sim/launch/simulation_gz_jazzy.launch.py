...
def _launch_setup(context):
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            "/model/kart/odometry@nav_msgs/msg/Odometry[gz.msgs.Odometry",
            "/model/kart/odom_gt@nav_msgs/msg/Odometry[gz.msgs.Odometry",
            "/kart/vel_cmd@geometry_msgs/msg/Twist]gz.msgs.Twist",
            "/kart/rgbd/image@sensor_msgs/msg/Image[gz.msgs.Image",
            "/kart/rgbd/depth_image@sensor_msgs/msg/Image[gz.msgs.Image",
            "/kart/rgbd/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo",
        ],
        remappings=[
