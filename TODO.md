...
- [ ] **Copy remaining SVO files to Orin** -- From Google Drive `formula 22-23/DRIVERLESS/BIG FILES/Videos ZED2/Data/` → `orin:~/kart-brain/data/svo/`. Best done on LAN (`orin-local`). Already copied: `HD720_..._18-05-10.svo`, `VGA_..._18-29-25.svo`, `HD720_..._19-15-54.svo`. Remaining (~75GB): `21_11_21/` (5 files), `21_11_19/` (3 files), `21_02_14/` (5 files), 4 large HD720s (11-22GB each). Nov 2021 files most likely to have FS cones.
