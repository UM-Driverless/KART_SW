...
# YOLO detector
ros2 run kart_perception yolo_detector --ros-args   -p image_topic:=/image_raw   -p detections_topic:=/perception/cones_2d   -p debug_image_topic:=/perception/yolo/annotated   -p weights_path:=models/perception/yolo/ruben_yolov11n_2026_03.pt &
